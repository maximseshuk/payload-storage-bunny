---
title: 'Thumbnails'
description: 'Populate a thumbnailURL field on upload documents for admin previews and API responses.'
---
...
- **Bunny Stream videos** — uses the frame captured at [`stream.thumbnailTime`](/configuration/stream/overview#options).
