...
<Update label="v3.0.1" description="September 23, 2026">
  **Fixes**

- The admin edit view no longer crashes on non-video uploads in Stream-enabled collections. `bunnyData` is now omitted from the response instead of being set to `null` — thanks [@PP-Tom](https://github.com/PP-Tom)!
