...
<Update label="v3.0.0" description="Unreleased">
  Not yet published to npm. See the [upgrade guide](/upgrade-guide#v2x-to-v30) for config changes and the data migration.
